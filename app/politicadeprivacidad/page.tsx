...
export default async function PrivacyPolicyPage() {
  ...
  const phone = business?.phone_display || '+595 995 364 978'
    ...
    <div className="legal">
      ...
      <main className="legal-main">
        ...
        <section className="legal-section">
          ...
          <p>
            En WIMALI Emprendimientos valoramos tu privacidad. Esta política explica qué información
            manejamos cuando usás nuestro catálogo web y cuando nos hacés un pedido a través de
            WhatsApp.
          </p>
        </section>
        ...
        <section className="legal-section">
          ...
          <ul>
            ...
            <li>
              <strong>Datos del pedido:</strong> cuando finalizás una compra, se abre WhatsApp con un
              mensaje ya redactado. Los datos que compartas los enviás vos directamente por WhatsApp y
              quedan en esa conversación.
            </li>
          </ul>
        </section>
        ...
        <section className="legal-section">
          ...
          <p>
            Usamos los datos que nos compartís por WhatsApp con un único fin: gestionar tu consulta o
            pedido, coordinar el pago, el retiro o el envío, y brindarte atención. No vendemos ni
        ...
        <section className="legal-section">
          ...
          <p>
            ...
            del navegador para recordar tu carrito y tus favoritos en este dispositivo.
          </p>
        </section>
        ...
        <section className="legal-section">
          ...
          <p>
            Como no guardamos tus datos en nuestros sistemas, la información que compartiste vive en tu
            conversación de WhatsApp. Podés pedirnos por ese medio que eliminemos los mensajes o los
            datos de un pedido cuando quieras.
          </p>
        </section>
        ...
        <section className="legal-section">
          <h2>7. Contacto</h2>
          <p>
            Ante cualquier duda sobre esta política, escribinos por WhatsApp al <strong>{phone}</strong>.
          </p>
        </section>
