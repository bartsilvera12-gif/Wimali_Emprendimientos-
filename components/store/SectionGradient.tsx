...
// Fondo de gradiente animado (WebGL) con la paleta WIMALI.
// variant 'light' para secciones claras, 'dark' para secciones oscuras.
const CONFIGS: Record<'light' | 'dark', CustomConfig> = {
  light: {
    preset: 'custom',
    color1: '#f6f1e7',
    color2: '#e8d3a6',
...
export function SectionGradient({ variant = 'light' }: { variant?: 'light' | 'dark' }) {
  return (
